...
import { getTranslationExecutors } from '$lib/server/executors/executor-registry';
...
export const POST: RequestHandler = async ({ request }) => {
	...
	return createTranslationResponse(form, request.signal, getTranslationExecutors());
};
